...
ggplot(joint,aes(x=Relative.Growth.Rate ,y=normd8toinputA,color=substr(file,1,11)))+geom_point()+facet_wrap(~phenotype,scales="free_x")+scale_y_log10()+scale_color_manual(values=distinct_colors)+theme_bw()+labs(x="Relative Growth Rate", y="Normalised abundance on day 8 of asexual screen", color="Pool")
