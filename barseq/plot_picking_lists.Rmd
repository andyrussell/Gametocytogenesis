...
ggplot(joint,aes(x=normd6toinputA+normd6toinputB+normd6toinputC ,y=Relative.Growth.Rate,color=substr(file,1,11)))+geom_point()+facet_wrap(~phenotype)+scale_x_log10()+scale_color_manual(values=distinct_colors)+theme_bw()
