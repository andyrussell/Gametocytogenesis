...
```{r}
pPlate <- ggplot(data = table_platemap, aes(x = Column, y = Row)) +
...
## save
ggsave("/Users/Andy/GCSKO/GCSKO_analysis_git/images_to_export/QC_failed_plates.png", plot = QC_failed_plates, device = "png", path = NULL, scale = 1, width = 22, height = 17, units = "cm", dpi = 300, limitsize = TRUE)
```
