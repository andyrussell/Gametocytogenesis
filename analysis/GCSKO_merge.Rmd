...
```{r, fig.height = 7, fig.width = 7}
## Plot
umap_cluster <- DimPlot(tenx.mutant.integrated, label = TRUE, label.size = 8, repel = TRUE, pt.size = 0.5, dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() +
  ...
  guides(colour=guide_legend(nrow = 3, byrow = TRUE, override.aes = list(size=8)))
...
p1 <- plot.list$`10X_WT` + 
  coord_fixed() +
  theme_void() +
  scale_color_manual(values=c(replicate(45, "#1D1564"))) +
  labs(title = paste("10X (wild-type)")) +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5, family="Arial", size = 13, face = "plain"))

p2 <- plot.list$WT +
  coord_fixed() +
  theme_void() +
  scale_color_manual(values=c(replicate(46, "#1D1564"))) +
...
save
```{r}
#ggsave("../images_to_export/ALLCELLS_merge_umap_technology_and_markers.png", plot = UMAP_composite, device = "png", path = NULL, scale = 1, width = 30, height = 30, units = "cm", dpi = 300, limitsize = TRUE)
```
...
pfd3 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_fd3, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
...
pmd4 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_md4, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pmd5 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_md5, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) +
  theme_void() + 
...
pfd4 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_fd4, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pfd2 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_fd2, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pmd3 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_md3, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pgd1 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_gd1, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pmd1 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_md1, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pmd2 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_md2, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
pfd1 <- DimPlot(tenx.mutant.integrated, label = FALSE, repel = TRUE, pt.size = 0.1, cells.highlight = cells_fd1, group.by = "exclude_for_sex_ratio", dims = c(2,1), reduction = "DIM_UMAP") + 
  coord_fixed() + 
  scale_color_manual(values=c("#D3D3D3", "#1D1564")) + 
  theme_void() + 
...
## plot composite plot
mutant_cell_locations <- plot_grid(pmd1 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pmd2 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pmd3 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pmd4 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pmd5 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")),
                                   
                                   pgd1 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pfd1 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pfd2 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pfd3 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   pfd4 + theme(plot.margin = unit(c(0, 0, 0, 0), "cm")), 
                                   nrow = 2)
...
## change guide titles  
guides(color=guide_legend(title="Genotype", override.aes = list(size=5))) +
theme(text = element_text(size = 10))
