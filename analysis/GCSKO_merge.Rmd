...
labels = c("fd3"="(PBANKA_1418100)","md4"="(PBANKA_0102400)","md5"="(PBANKA_0716500)","fd4"="(PBANKA_1435200)","fd2"= "PBANKA_0902300","md3"="(PBANKA_0413400)","gd1"= "(PBANKA_0828000)","md1"="(PBANKA_1302700)","md2"="(PBANKA_1447900)","fd1"= "(PBANKA_1454800)")
...
## plot composite plot
mutant_cell_locations <- wrap_plots(plots,ncol=2)
